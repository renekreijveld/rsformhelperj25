...
$document->addStyleSheet('components/com_rsformhelper/assets/css/bootstrap.min.css');
$document->addStyleSheet('components/com_rsformhelper/assets/css/bootstrap-responsive.min.css');
...
<form action="<?php echo JRoute::_('index.php?option=com_rsformhelper&view=formselects'); ?>" method="post" name="adminForm" id="adminForm" class="form-horizontal">
	...
	<div class="span9">
		...
		<?php } else { ?>
			<a class="btn btn-success" style="color:#ffffff;" href="index.php?option=com_rsformhelper&view=formselects">Restart</a>&nbsp;<a class="btn" href="index.php?option=com_rsform&view=forms">Take me to RSForm!Pro</a>
		...
		<div class="control-group tdcsscaption">
			<label class="control-label">
				<a class="hasTooltip nolink" title="CSS code to be applied to the column that displays the form field caption." data-toggle="tooltip" href="#">TD css caption <span class="icon-info"></span></a><br/>
			</label>
			<div class="controls">
		...
		<div class="control-group">
			<label class="control-label">
				<a class="hasTooltip nolink" title="CSS code to be applied to the column that displays the form field value." data-toggle="tooltip" href="#">TD css value <span class="icon-info"></span></a><br/>
			</label>
			<div class="controls">
